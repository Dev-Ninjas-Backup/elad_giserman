...
class HomeScreen extends StatelessWidget {
                              ...
                              return Obx(
                                () => PopularNearWidget(
                                  ...
                                  isFavorite: controller
                                      .isFavoriteBusiness(profile.id),
                                  onFavoriteTap: () {
                                    controller.toggleFavoriteBusiness(
                                        profile.id);
                                  },
  ...
  Widget _buildSearchResultsView(HomeController controller) {
    return Column(
      children: [
        HomeAppBar(),
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "found_results"
                    .trParams({'count': controller.searchResults.length.toString()}),
                style: const TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w400,
                  color: AppColors.fontColor,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(
                      () => RecommendedVenue(
                        ...
                        description: profile.description,
                        location: profile.location,
                        isFavorite: controller.isFavoriteBusiness(profile.id),
                        onFavoriteTap: () {
